...
import com.example.lastmenu.CekGonderActivity;
...
public class JSONIlceParser extends AsyncTask<Void,Void,Boolean> {
    ...
    public JSONIlceParser(Context c, String jsonData, MaterialSpinner ms) {
        this.c = c;
        ...
        if(isParsed){
            ...
            ms.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener() {
                ...
                public void onItemSelected(MaterialSpinner view, int position, long id, Object item) {
                   ...
                   /*String st = users.get(position);


                    if(st.equals("Battalgazi")){

                        Toast.makeText(c, st, Toast.LENGTH_SHORT).show();
