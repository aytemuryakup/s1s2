...
public class JSONKateParser  extends AsyncTask<Void,Void,Boolean> {
    ...
    public JSONKateParser(Context c, String jsonData, MaterialSpinner ms) {
        this.c = c;
