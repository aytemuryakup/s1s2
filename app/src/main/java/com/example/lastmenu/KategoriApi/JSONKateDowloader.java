package com.example.lastmenu.KategoriApi;
...
public class JSONKateDowloader extends AsyncTask<Void,Void,String> {
    ...
    public JSONKateDowloader(Context c, String jsonURL, MaterialSpinner ms) {
        this.c = c;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData.startsWith("Error")){
            ...
            new JSONKateParser(c,jsonData,ms).execute();
