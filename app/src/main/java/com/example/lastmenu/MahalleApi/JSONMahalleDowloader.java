...
public class JSONMahalleDowloader extends AsyncTask<Void,Void,String> {
    ...
    public JSONMahalleDowloader(Context c, String jsonURL, MaterialSpinner ms) {
        this.c = c;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData.startsWith("Error")){
            ...
            new JSONMahalleParser(c,jsonData,ms).execute();
